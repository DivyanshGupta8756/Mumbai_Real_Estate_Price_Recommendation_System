# 🏙️ Mumbai Real Estate Price & Recommendation System

## 📌 Project Overview
This project develops a **data-driven real estate analytics system** focused on the Mumbai housing market. The system predicts residential property prices and recommends suitable properties based on user-defined inputs, enabling informed **market feasibility and pricing decisions**.
...
- Recommend properties that best match user preferences  
...
1. **Data Understanding & Cleaning**
   - Processed Mumbai housing dataset containing location, area, configuration, and pricing attributes  
   - Handled missing values, categorical variables, and outliers  

2. **Exploratory Data Analysis (EDA)**
   - Analyzed price variations across locations  
   - Studied relationships between area, BHK configuration, and price  
   - Identified dominant pricing drivers in Mumbai’s residential market  

3. **Price Prediction Model**
   - Trained machine learning regression models to estimate flat prices  
...
- Location-sensitive property recommendations  
